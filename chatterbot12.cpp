//
// Program Name: Chatterbot12
// The purpose of Chatterbot12 is to introduce Text To Speech within the program, so far all the responses of the chatterbot was printed
// directly into the DOS console window, with these new version of the chatbot, the program is now capable to 'speak' out the answer that
// it has selected. In order to do this, the Text To Speech engine from the SAPI SDK of microsoft was used. So it is assumed that these library
// is already installed on the corresponding computer where the program will be runing, otherwise it can download at msdn.com
//
// Author: Gonzales Cenelia
//

#include "chatterbot12.h"
...
/*
	...
	{"HELLO USER, WHAT IS YOUR NAME?",
	 ...
	 "YOU ARE NOW CHATING WITH CHATTERBOT12, ANYTHING YOU WANT TO DISCUSS?"}
	},
...
int main()
{
	std::cout << "Chatterbot v12.0 Copyright (C) 2009 Gonzales Cenelia\n" << std::endl;
	try
	{
		CBot bot("Chatterbot12");
